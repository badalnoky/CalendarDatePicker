#
# Be sure to run `pod lib lint CalendarDatePicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CalendarDatePicker.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'CalendarDatePicker' => ['CalendarDatePicker/Assets/*.png']
  # }
